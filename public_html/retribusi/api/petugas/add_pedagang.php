...
//         }else {
	    ...
	    // required post params is missing
	        $query ="INSERT INTO `pedagang`(`user_id`, `status`, `name`,  `email`, `profile_pic`, `user_type`, `alamat`, `keterangan`, `telp`, `latitude`, `longitude`, `no_kios`, `foto_kios`, `dagangan`, `foto_npwp`, `foto_ktp`, `create_date`, `id_pedagang`, `id_pasar`, `mulai_jualan`) VALUES ('$usersr','active','$nama_pedagang','$email','$photo','admin pasar','$alamat','Sudah Terverifikasi','$telp','$latitude','$longitude','$no_kios','$foto_kios','$dagangan','$foto_npwp','$foto_ktp','$tanggal','$id_rand','$id_pasar','$mulai_jualan')";
	        if ($result2 =mysqli_query($con, $query) ){
	            $query ="INSERT INTO `log_pedagang`(`user_id`, `status`, `name`,  `email`, `profile_pic`, `user_type`, `alamat`, `keterangan`, `telp`, `latitude`, `longitude`, `no_kios`, `foto_kios`, `dagangan`, `foto_npwp`, `foto_ktp`, `id_pedagang`, `id_pasar`, `mulai_jualan`) VALUES ('$user_id','insert','$nama_pedagang','$email','$photo','admin pasar','$alamat','Sudah Terverifikasi','$telp','$latitude','$longitude','$no_kios','$foto_kios','$dagangan','$foto_npwp','$foto_ktp','$id_rand','$id_pasar','$mulai_jualan')";
